...
class PnWeatherTvc: UITableViewController, AddCitiesDelegate {
    ...
    func methodAddCities(_ data: PnCityModel) {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "WeatherInformationCell", for: indexPath) as? PnWeatherInfoTvCell else {
...
extension PnWeatherTvc {
    ...
    private func prepareSegueForSettingsVC(segue: UIStoryboardSegue) {
        if
            ...
            let _ = navigationController.viewControllers.first as? PnSettingsVc
        {
//            SettingsVc.delegate = self
    ...
    private func prepareSegueForAddWeatherVC(segue: UIStoryboardSegue) {
        if
            let navigationController = segue.destination as? UINavigationController,
            let CitiesVC = navigationController.viewControllers.first as? PnAddCitiesVc
        {
