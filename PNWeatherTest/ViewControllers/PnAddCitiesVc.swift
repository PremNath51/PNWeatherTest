...
class PnAddCitiesVc: UIViewController {
    @IBOutlet weak var tableView: UITableView!
    @IBOutlet weak var searchBar: UISearchBar!

    var cityList: [PnCityModel] = [PnCityModel]()
    var filteredList: [PnCityModel] = [PnCityModel]()
...
extension PnAddCitiesVc: UISearchBarDelegate {
...
extension PnAddCitiesVc: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "AddCitiesCell", for: indexPath) as? PnAddCitiesTVCell else {
...
extension PnAddCitiesVc: UITableViewDelegate {
